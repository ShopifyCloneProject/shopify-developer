                                          ...
                                          <td colspan="2" style="font-family: 'Montserrat',Arial,sans-serif;">
                                             <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                ...
                                                <tr>
                                                   ...
                                                   <td align="right" style="font-family: 'Montserrat',Arial,sans-serif; font-size: 14px; text-align: center; width: 15%;" width="15%"><span style="font-family: DejaVu Sans; sans-serif;">{{ $data['currencySymbol'] }}</span> {{ $product['price'] }} </td>
                                                   ...
                                                   <td align="right" style="font-family: 'Montserrat',Arial,sans-serif; font-size: 14px; text-align: right; width: 15%;" width="15%"><span style="font-family: DejaVu Sans; sans-serif;">{{ $data['currencySymbol'] }}</span> {{ number_format($product['price'] * $product['quantity'], 2)}} </td>
                                                </tr>
                                                @endforeach
                                                <tr>
                                                   ...
                                                   <td colspan="2" style="font-family: 'Montserrat',Arial,sans-serif; width: 50%;border-top: 1px solid #ddd;padding-top: 15px;" width="50%">
                                                      <p align="right" style="font-weight: 700; font-size: 14px; line-height: 24px; margin: 0; text-align: right;">
                                                         <span style="font-family: DejaVu Sans; sans-serif;">{{ $data['currencySymbol'] }}</span> {{$data['total']}}
                                                      </p>
                                                   </td>
                                                </tr>
                                                <tr>
                                                   ...
                                                   <td colspan="2" style="font-family: 'Montserrat',Arial,sans-serif; width: 50%;border-top: 1px solid #ddd;padding-top: 15px;" width="50%">
                                                      <p align="right" style="font-weight: 700; font-size: 14px; line-height: 24px; margin: 0; text-align: right;">
                                                         <span style="font-family: DejaVu Sans; sans-serif;">{{ $data['currencySymbol'] }}</span> {{$data['shippingCost']}}
                                                      </p>
                                                   </td>
                                                </tr>
                                                <tr>
                                                   ...
                                                   <td colspan="2" style="font-family: 'Montserrat',Arial,sans-serif; width: 50%;border-top: 1px solid #ddd;padding-top: 15px;" width="50%">
                                                      <p align="right" style="font-weight: 700; font-size: 14px; line-height: 24px; margin: 0; text-align: right;">
                                                         <span style="font-family: DejaVu Sans; sans-serif;">{{ $data['currencySymbol'] }}</span> {{$data['taxes']}}
                                                      </p>
                                                   </td>
                                                </tr>
                                                @if($data['discount'] > 0)
                                                <tr>
                                                   ...
                                                   <td colspan="2" style="font-family: 'Montserrat',Arial,sans-serif; width: 50%;border-top: 1px solid #ddd;padding-top: 15px;" width="50%">
                                                      <p align="right" style="font-weight: 700; font-size: 14px; line-height: 24px; margin: 0; text-align: right;">
                                                         <span style="font-family: DejaVu Sans; sans-serif;">{{ $data['currencySymbol'] }}</span> {{$data['discount']}}
                                                      </p>
                                                   </td>
                                                </tr>
                                                @endif
