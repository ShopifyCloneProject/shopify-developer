...
<div class="customizer d-none d-md-block">
  ...
  <div class="customizer-content">
    ...
    <div class="customizer-styling-direction px-2">
      ...
      <div class="d-flex">
        <div class="custom-control custom-radio mr-1">
          <input type="radio" id="skinlight" name="skinradio" class="custom-control-input layout-name" {{ $configData['theme'] == 'light' ? 'checked': ''}} data-layout="" />
          <label class="custom-control-label" for="skinlight">Light</label>
        </div>
        <div class="custom-control custom-radio mr-1">
          <input type="radio" id="skinbordered" name="skinradio" class="custom-control-input layout-name" data-layout="bordered-layout" {{ $configData['theme'] == 'bordered' ? 'checked': ''}} />
          <label class="custom-control-label" for="skinbordered">Bordered</label>
        </div>
        <div class="custom-control custom-radio mr-1">
          <input type="radio" id="skindark" name="skinradio" class="custom-control-input layout-name" data-layout="dark-layout" {{ $configData['theme'] == 'dark' ? 'checked': ''}} />
          <label class="custom-control-label" for="skindark">Dark</label>
        </div>
        <div class="custom-control custom-radio">
          <input type="radio" id="skinsemidark" name="skinradio" class="custom-control-input layout-name" data-layout="semi-dark-layout" {{ $configData['theme'] == 'semi-dark' ? 'checked': ''}} />
    ...
    <div class="customizer-navbar px-2">
      ...
      <div class="d-flex">
        <div class="custom-control custom-radio mr-1">
          <input type="radio" id="nav-type-floating" name="navType" class="custom-control-input" {{ $configData['horizontalMenuType'] == 'navbar-floating' ? 'checked': ''}} />
          <label class="custom-control-label" for="nav-type-floating">Floating</label>
        </div>
        <div class="custom-control custom-radio mr-1">
          <input type="radio" id="nav-type-sticky" name="navType" class="custom-control-input" {{ $configData['horizontalMenuType'] == 'navbar-sticky' ? 'checked': ''}} />
          <label class="custom-control-label" for="nav-type-sticky">Sticky</label>
        </div>
        <div class="custom-control custom-radio mr-1">
          <input type="radio" id="nav-type-static" name="navType" class="custom-control-input" {{ $configData['horizontalMenuType'] == 'navbar-static' ? 'checked': ''}} />
          <label class="custom-control-label" for="nav-type-static">Static</label>
        </div>
        <div class="custom-control custom-radio">
          <input type="radio" id="nav-type-hidden" name="navType" class="custom-control-input" {{ $configData['horizontalMenuType'] == 'navbar-hidden' ? 'checked': ''}} />
