    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.order-products.update", [$orderProduct->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $orderProduct->email) }}" required>
                @if($errors->has('email'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile') ? 'is-invalid' : '' }}" type="number" name="mobile" id="mobile" value="{{ old('mobile', $orderProduct->mobile) }}" required>
                @if($errors->has('mobile'))
                    <span class="text-danger">{{ $errors->first('mobile') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.orderProduct.fields.mobile_helper') }}</span>
            </div>
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('variantoptions') ? 'is-invalid' : '' }}" name="variantoptions_id" id="variantoptions_id">
                    @foreach($variantoptions as $id => $entry)
                        <option value="{{ $id }}" {{ (old('variantoptions_id') ? old('variantoptions_id') : $orderProduct->variantoptions->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $orderProduct->title) }}" required>
                @if($errors->has('title'))
             ...
             <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('slug') ? 'is-invalid' : '' }}" type="text" name="slug" id="slug" value="{{ old('slug', $orderProduct->slug) }}" required>
                @if($errors->has('slug'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" type="text" name="price" id="price" value="{{ old('price', $orderProduct->price) }}" required>
                @if($errors->has('price'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('quantity') ? 'is-invalid' : '' }}" type="text" name="quantity" id="quantity" value="{{ old('quantity', $orderProduct->quantity) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sku') ? 'is-invalid' : '' }}" type="text" name="sku" id="sku" value="{{ old('sku', $orderProduct->sku) }}" required>
                @if($errors->has('sku'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('barcode') ? 'is-invalid' : '' }}" type="text" name="barcode" id="barcode" value="{{ old('barcode', $orderProduct->barcode) }}" required>
            ...
            <div class="form-group">
                <label for="weightmanage_id">{{ trans('cruds.orderProduct.fields.weight_type') }}</label>
                <select class="form-control select2 {{ $errors->has('weightmanage') ? 'is-invalid' : '' }}" name="weightmanage_id" id="weightmanage_id">
                    @foreach($weightmanage as $id => $entry)
                        <option value="{{ $id }}" {{ (old('weightmanage_id') ? old('weightmanage_id') : $orderProduct->weightmanage->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('weightmanage'))
                    <span class="text-danger">{{ $errors->first('weightmanage') }}</span>
                @endif
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('weight') ? 'is-invalid' : '' }}" type="text" name="weight" id="weight" value="{{ old('weight', $orderProduct->weight) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hs_code') ? 'is-invalid' : '' }}" type="text" name="hs_code" id="hs_code" value="{{ old('hs_code', $orderProduct->hs_code) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('is_product_charge') ? 'is-invalid' : '' }}" type="text" name="is_product_charge" id="is_product_charge" value="{{ old('is_product_charge', $orderProduct->is_product_charge) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('is_track') ? 'is-invalid' : '' }}" type="text" name="is_track" id="is_track" value="{{ old('is_track', $orderProduct->is_track) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('is_special_product') ? 'is-invalid' : '' }}" type="text" name="is_special_product" id="is_special_product" value="{{ old('is_special_product', $orderProduct->is_special_product) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('special_price') ? 'is-invalid' : '' }}" type="text" name="special_price" id="special_price" value="{{ old('special_price', $orderProduct->special_price) }}" required>
