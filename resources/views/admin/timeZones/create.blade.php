...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.timeZone.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.time-zones.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('timezone_value') ? 'is-invalid' : '' }}" type="text" name="timezone_value" id="timezone_value" value="{{ old('timezone_value', '') }}" required>
