    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.stocks.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('available_quantity') ? 'is-invalid' : '' }}" type="number" name="available_quantity" id="available_quantity" value="{{ old('available_quantity', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('defect_quantity') ? 'is-invalid' : '' }}" type="text" name="defect_quantity" id="defect_quantity" value="{{ old('defect_quantity', '') }}">
