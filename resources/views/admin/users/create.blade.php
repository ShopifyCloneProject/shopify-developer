    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\User::GENDER_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('gender') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="gender_{{ $key }}" name="gender" value="{{ $key }}" {{ old('gender', 'M') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\User::IS_VERIFIED_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('is_verified') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="is_verified_{{ $key }}" name="is_verified" value="{{ $key }}" {{ old('is_verified', '1') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\User::EMAIL_NOTIFICATION_STATUS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('email_notification_status') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="email_notification_status_{{ $key }}" name="email_notification_status" value="{{ $key }}" {{ old('email_notification_status', '1') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\User::SMS_NOTIFICATION_STATUS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('sms_notification_status') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="sms_notification_status_{{ $key }}" name="sms_notification_status" value="{{ $key }}" {{ old('sms_notification_status', '1') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\User::BLOCKED_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('blocked') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="blocked_{{ $key }}" name="blocked" value="{{ $key }}" {{ old('blocked', '1') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\User::ACCEPT_MARKETING_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('accept_marketing') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="accept_marketing_{{ $key }}" name="accept_marketing" value="{{ $key }}" {{ old('accept_marketing', '1') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_spent') ? 'is-invalid' : '' }}" type="number" name="total_spent" id="total_spent" value="{{ old('total_spent', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_orders') ? 'is-invalid' : '' }}" type="number" name="total_orders" id="total_orders" value="{{ old('total_orders', '0') }}" step="1">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\User::TAX_EXEMPT_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('tax_exempt') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="tax_exempt_{{ $key }}" name="tax_exempt" value="{{ $key }}" {{ old('tax_exempt', '1') === (string) $key ? 'checked' : '' }}>
