...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.productVariantOption.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.product-variant-options.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('variant_option_1') ? 'is-invalid' : '' }}" name="variant_option_1_id" id="variant_option_1_id">
                    @foreach($variant_option_1s as $id => $entry)
                        <option value="{{ $id }}" {{ old('variant_option_1_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('variant_option_2') ? 'is-invalid' : '' }}" name="variant_option_2_id" id="variant_option_2_id">
                    @foreach($variant_option_2s as $id => $entry)
                        <option value="{{ $id }}" {{ old('variant_option_2_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('variant_option_3') ? 'is-invalid' : '' }}" name="variant_option_3_id" id="variant_option_3_id">
                    @foreach($variant_option_3s as $id => $entry)
                        <option value="{{ $id }}" {{ old('variant_option_3_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('compare_at_price') ? 'is-invalid' : '' }}" type="number" name="compare_at_price" id="compare_at_price" value="{{ old('compare_at_price', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cost_per_item') ? 'is-invalid' : '' }}" type="number" name="cost_per_item" id="cost_per_item" value="{{ old('cost_per_item', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\ProductVariantOption::IS_PRODUCT_CHARGE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('is_product_charge') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="is_product_charge_{{ $key }}" name="is_product_charge" value="{{ $key }}" {{ old('is_product_charge', '0') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_track') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_track" id="is_track" value="1" {{ old('is_track', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_continue_selling') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_continue_selling" id="is_continue_selling" value="1" {{ old('is_continue_selling', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_physical_product') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_physical_product" id="is_physical_product" value="1" {{ old('is_physical_product', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('weight_type') ? 'is-invalid' : '' }}" name="weight_type_id" id="weight_type_id">
                    @foreach($weight_types as $id => $entry)
                        <option value="{{ $id }}" {{ old('weight_type_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_special_product') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_special_product" id="is_special_product" value="1" {{ old('is_special_product', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control date flatpickr-basic  {{ $errors->has('expiry_date') ? 'is-invalid' : '' }}" type="text" name="expiry_date" id="expiry_date" value="{{ old('expiry_date') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('special_product_status') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="special_product_status" id="special_product_status" value="1" {{ old('special_product_status', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_shipping') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_shipping" id="is_shipping" value="1" {{ old('is_shipping', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_taxable') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_taxable" id="is_taxable" value="1" {{ old('is_taxable', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reorder') ? 'is-invalid' : '' }}" type="number" name="reorder" id="reorder" value="{{ old('reorder', '') }}" step="1" required>
