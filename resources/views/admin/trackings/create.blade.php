...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.trackings.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.trackings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="description">{{ trans('cruds.trackings.fields.description') }}</label>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status_code') ? 'is-invalid' : '' }}" type="text" name="status_code" id="status_code" value="{{ old('status_code', '') }}" required>
