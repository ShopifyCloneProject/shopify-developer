        ...
        <li class="nav-item dropdown dropdown-user">
          <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="user-nav d-sm-flex d-none">
              ...
              <span class="user-status">{{$authuser->role->title}}</span>
            </div>
             @if(file_exists(public_path($authuser->image)))
            <span class="avatar">
              <img class="round" src="{{$authuser->image}}" alt="avatar" height="40" width="40">
              <span class="avatar-status-online"></span>
            </span>
            @else
              <span class="avatar">
                <img class="round" src="{{asset('/images/avatars/11-small.png')}}" alt="avatar" height="40" width="40">
                <span class="avatar-status-online"></span>
              </span>
            @endif
            @endif
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
            ...
            <a class="dropdown-item" href="{{ route('admin.manage-account') }}">
              <i class="mr-50" data-feather="settings"></i> {{ trans('global.settings') }}
            </a>
          {{--   <a class="dropdown-item" href="{{url('page/pricing')}}">
            ...
            <a class="dropdown-item" href="{{ route('adminLogout') }}">
              <i class="mr-50" data-feather="power"></i> {{ trans('global.logout') }}
            </a>
          </div>
        </li>
      </ul>
