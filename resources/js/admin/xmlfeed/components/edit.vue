                ...
                <div class="card">
                    <div class="card-body">
                       ...
                       <ValidationProvider  name="XML Feed Name" rules="required" v-slot="{ errors }">
                        ...
                        <div id="infinite-list" v-show="XMLOption == 0">
                        ...
                        <div id="collections-list" v-show="XMLOption == 1">
...
export default {
    ...
    created(){
        this.selectedProductList = this.data.selectedProductList;
        this.id = this.data.xmlsData.id;
        this.XMLFeedName = this.data.xmlsData.title;
        this.XMLOption = this.data.xmlsData.product_type;
        this.productOption = this.data.xmlsData.option_type;

        if(this.XMLOption == 0 && this.productOption == 1){
            this.loadMore();
        } else if(this.XMLOption == 1 && this.productOption == 1){
            this.callGetCollection();
        }
    },
    computed: {
        noImage(){
    ...
    methods: {
        ...
        getCollectionProducts(){
            ...
            blockSection(section);
            this.$store.dispatch("xmlfeedModule/GetCollectionProducts", this.id)
            .then((res) => {
                if (res.response.status_code == 2044) {
