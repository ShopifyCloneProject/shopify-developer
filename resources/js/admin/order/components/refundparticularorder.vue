<template>
  <div id="input-sizing">
      <form method="POST"  id="frmRefundProduct">
          <div class="row mb-2">
          <div class="col-sm-12">
            <div class="collapse-icon">
                <div class="collapse-margin" id="accordionExample">
                  <div class="card">
                    ...
                    >
                      <h3 class="lead collapse-title"> Order Details ({{ getFinancialStatus }}) </h3>
                    </div>
                    ...
                    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                      <div class="card-body">
                          <div class="row">
                              ...
                              <div class="col-md-2">{{data.order.currency_symbol}} {{data.order.sub_total}}</div>
                          </div>
                          <div class="row">
                              <div class="col-md-10">Shipping cost</div>
                              <div class="col-md-2">{{data.order.currency_symbol}} {{data.order.shipping_cost}}</div>
                          </div>
                          <div class="row">
                              <div class="col-md-10">Taxes</div>
                              <div class="col-md-2">{{data.order.currency_symbol}} {{data.order.taxes}}</div>
                          </div>
                          <div class="row">
                              <div class="col-md-10">Discount amount <span v-if="data.order.discount_amount > 0">({{data.order.discount_code}})</span></div>
                              <div class="col-md-2">{{data.order.currency_symbol}} {{data.order.discount_amount}}</div>
                          </div>
                          <hr class="mb-1">
                          <div class="row">
                              <div class="col-md-10">Paid by customer</div>
                              <div class="col-md-2">{{data.order.currency_symbol}} {{data.paidByCustomer}}</div>
                          </div>
                          <div class="row">
                              <div class="col-md-10">Total Costing</div>
                              <div class="col-md-2">{{data.order.currency_symbol}} {{data.totalCosting}}</div>
                          </div>
                          <hr class="mb-1">
                          <div class="row">
                              <div class="col-md-10">Total Profit</div>
                              <div class="col-md-2">{{data.order.currency_symbol}} {{data.profit}}</div>
                          </div>
                          <div class="row" v-if="data.objRefunds.length > 0">
                              <div class="col-md-12">
                                  <div class="card">
                                      <div class="card-header">
                                      <h3 class="lead collapse-title">Refund Details ({{ getFinancialStatus }})</h3>
                                  </div>
                                  <div class="card-body">
                                      <div class="table-responsive">
                                          <table class="table">
                                              ...
                                              <tbody>
                                                  <tr v-for="(refund, index) in data.objRefunds" :key="index">
                                                      <td class="text-center">
                                                          <div>Refund : {{ index }}</div>
                                                      </td>
                                                      <td class="text-center">
                                                      ...
                                                      <td class="text-center">
                                                          <div>
                                                             {{data.order.currency_symbol}} {{refund.amount}}
                                                          </div>
                                                      </td>
                                                  </tr>
                                              </tbody>
    ...
    <!-- Refund Data Modal Start-->
        <div class="modal fade pr-0" id="RefundData" tabindex="-1" role="dialog" aria-labelledby="refundDataTitle" aria-hidden="true">
          <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="refundDataTitle">Refund Data</h5>
        ...
        <div class="row">
          <div class="col-md-12 col-12">
            ...
            <div class="form-group float-left" v-if="data.order.financial_status != 'refunded'">
              <button class="btn btn-primary waves-effect waves-light" type="button" @click="saveApprove()">
                {{ lang.global.refund }}
              </button>
  ...
  export default {
    ...
    methods: {
      ...
      increaseQuantity(index){
        if(this.refundProducts[index].currentRefundQuantity >= this.data.objSelectionProducts[index].requestReturnQuantity){
...
<style lang="scss" scoped>
  ...
  .cart-table-prd .prd-description,{
