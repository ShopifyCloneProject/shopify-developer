        ...
        <form @submit.prevent="handleSubmit(saveProduct())">
          <div class="row">
            <div class="col-md-8 col-12">
                  ...
                  <!-- Basic details end -->
                  <!-- Media start -->
                  <div class="card" id="mediaData">
                      <div class="card-header">
                         <h4 class="card-title">{{ lang.global.media }}</h4>
                         <button v-if="showDeleteBtn" @click="deleteMedia" type="button" class="btn btn-outline-warning waves-effect pull-right">{{ lang.global.deleteselectmedia }}</button>
                      </div>
                      <div class="card-body">
                        <section>
                         ...
                         <div class="row">
                              <div class="col-12">
                                  <div class="demo-inline-spacing">
                                       <label class="required">{{ lang.cruds.product.fields.is_product_charge }}</label>
                                        <div class="custom-control custom-radio" v-for="(ldata, index) in list.is_product_charge">
                                            <input type="radio" :id="`is_product_charge_${index}`" class="custom-control-input" v-model="product.is_product_charge" :value="index"/>
                                            <label class="custom-control-label" :for="`is_product_charge_${index}`">{{ ldata }}</label>
                                        </div>
                                    </div>
                              </div>
                         </div>
                          ...
                          <div class="row">
                            <div class="col-6">
                               <div class="form-group">
                                   ...
                                   <input class="form-control" type="text" v-model="product.sku" @change="changeAllSku()">
                                </div>
                            </div>
                            <div class="col-6">
                               <div class="form-group">
                              ...
                              <div class="col-12">
                                  <div class="form-group ">
                                       ...
                                       <div class="row">
                                        ...
                                        <div class="col-2">
                                          <select class="custom-select" name="weight_type_id" id="weight_type_id" v-model="product.weight_type">
                          ...
                          <hr />
                              <div class="col-12">
                                   <div class="form-group">
                                       ...
                                       <select class="custom-select" name="country_id" id="country_id" v-model="product.country">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <input class="form-control" type="text" name="hs_code" id="hs_code" v-model="product.hs_code">
                                    </div>
                              </div>
                          </div>
                      </div>
                                        ...
                                        <tr >
                                          <th>
                                            <div class="custom-control custom-control-primary custom-checkbox">
                                             <!--  <input type="checkbox" class="custom-control-input" id="variantCombinationData_all"  /> -->
                                      ...
                                      <tbody>
                                        <tr @click.prevent="openEditProductVariant($event,index)" v-for="(variantCombinationData, index) in productVariantCombination">
                                          <td>
                                            <div class="demo-inline-spacing">
                                                <div class="custom-control custom-control-primary custom-checkbox">
                                                 <!--  <input v-model="variantCombinationData.checked" type="checkbox" class="custom-control-input" :id="'variantCombinationData_'+index"  /> -->
                                                  <label class="custom-control-label checkbox-label cursor " :for="'variantCombinationData_'+index">{{  variantCombinationData.variant_name}}</label>
                                                </div>
                                            </div>
                                          </td>
                         ...
                         <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                   ...
                                   <input class="form-control" type="text" name="seo_title" id="seo_title" v-model="product.seo_title">
                                </div>
                                <div class="form-group">
                                   <label for="seo_description">{{ lang.cruds.product.fields.seo_description }}</label>
                                  <textarea class="form-control" name="seo_description" id="seo_description" v-model="product.seo_description"></textarea>
                                </div>
                            </div>
                         </div>
                      </div>
                  ...
                  <div class="card-body">
                     <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-group sel-collection-section" v-if="list.collections.length > 0">
                            ...
                            <div class="form-group">
                                ...
                                <span class="badge badge-glow badge-primary mb-1 mr-1 pointer" @click.prevent="onRemoveCollections(collectionSelectdata)">{{ collectionSelectdata.title }}  &#10006; </span>
                                </span>
                            </div>
                            <div class="form-group">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="row">
                            <div class="col-xl-6 col-md-6 col-12 mb-1">
                                <div class="form-group">
                                    <label for="cost_per_item">{{ lang.cruds.product.fields.cost_per_item }} ({{ lang.global.customerNotSee }})</label>
                                    <div class="input-group input-group-merge mb-2">
                                       <div class="input-group-prepend">
                                          <span class="input-group-text" id="basic-addon5">{{ lang.global.current_currency }}</span>
                                       </div>
                      ...
                      <hr>
                      <h4>{{  lang.cruds.product.quantity }}</h4>
                      <div class="row">
                           <div class="col-xl-9 col-md-9 col-12 mb-1">
                                <div class="form-group">
                                    <label>{{ lang.global.location }} {{ lang.global.name }} </label>
                                </div>                              
                            </div>
                             <div class="col-xl-3 col-md-3 col-12 mb-1">
                                <div class="form-group">
                                    <label>{{ lang.cruds.stock.fields.available_quantity }}</label>
                                </div>                              
                            </div>
                      </div>
                      <hr>
                      <div class="row" v-if="editVariantCombination.length > 0  ">
                           <div class="col-xl-9 col-md-9 col-12 mb-1" v-if="editVariantCombination.locations[0].length > 0">
                                <div class="form-group">
                                    <h5> {{ editVariantCombination.locations[0].name }}</h5>
                                </div>                              
                            </div>
                             <div class="col-xl-3 col-md-3 col-12 mb-1"  v-if="editVariantCombination.locations[0].length > 0">
                                <div class="form-group">
                                    <input type="text" class="form-control" v-model="editVariantCombination.locations[0].available" />
                                </div>                              
                            </div>
                      </div>
                       <hr>
                      ...
                      <div class="row">
                          <div class="col-12 mb-1">
                              <div class="form-group">
                                <label>{{ lang.global.hs_code }}</label>
                                <input type="text" class="form-control"  v-model="editVariantCombination.hs_code" />
  ...
  export default {
    ...
    data() {
      return {
            ...
            taggingSelected: [],
             mediaData: [],
             product: {title: '',  description: '',  price: '',  compare_at_price: '',  cost_per_item: '',  is_product_charge: 0,
                       sku: '', barcode: '',  is_track: false,  is_continue_selling: false, quantity: '',  min_order_limit: '',  
                       max_order_limit: '',  is_cod_enabled: false,  is_size_chart_enabled: false,  is_special_product: false,  
                       special_product_status: false,  special_price: '', expiry_date: '', is_physical_product: false,  weight: '', 
                       weight_type: 0, country: 101,  hs_code: '', seo_title: '',  seo_description: '',  status: 0,  is_online:  false, 
                       product_type: [], vendor : [], collections: [], tags: [], is_gift_card: false, is_product_variant: false, variants: [],variantData: [], action: '', media: [], schedule_time: ''
                       },
      } 
    },
    components: {
    ...
    mounted() {
        ...
        if(this.list.action == 'add')
        {
            ...
            this.product.weight_type = Object.keys(this.list.weight_type)[0];
        }
        else
        {
            this.objVariantData = this.list.variant_data;
            this.product = this.list.product;
            this.product.country = this.product.country_id;
            this.product.weight_type = this.product.weight_type_id;
    ...
    methods: {
        ...
        passImageData(event){
            ...
            unblockSection($("#mediaData"));
        },
        appendMedia(base64image){
            this.mediaData.push({id: Math.floor((Math.random() * -10000000)),  imageurl: base64image, checked: false, displaycheckbox: false });
        },
        saveProduct(){
        ...
        onRemoveCollections(options) {
          ...
          let selectedIndex = this.collectionSelected.findIndex(item => item.id==options.id);
          this.collectionSelected.splice(selectedIndex,1);   
        },
