         ...
         <div class="col-12">
            <div class="card">
               <div class="card-header">
                  <h4 class="card-title">Description section</h4>
               ...
               <div class="card-content collapse">
                  <div class="card-body">
                     <div class="row" id="descriptionData">
                        <div class="col-sm-12">
                           <div class="custom-control custom-control-primary custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="descriptionDisplay" v-model="list.status"/>
                              <label class="custom-control-label" for="descriptionDisplay">Is Visible</label>
                           </div>
                        </div>
                     </div>
                  </div>
