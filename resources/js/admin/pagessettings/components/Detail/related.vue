         ...
         <div class="col-12">
            <div class="card">
               <div class="card-header">
                  <h4 class="card-title">Related products section</h4>
               ...
               <div class="card-content collapse">
                  <div class="card-body">
                     <div class="row" id="relatedData">
                        <div class="col-sm-12">
                           <div class="demo-inline-spacing layout-sec">
                              <h5 class="mr-1">Visible on page:</h5>
                              <div class="custom-control custom-control-primary custom-checkbox">
                                 <input type="checkbox" class="custom-control-input" id="relatedDisplay" v-model="list.status"/>
                                 <label class="custom-control-label" for="relatedDisplay"></label>
                              </div>
                           </div>
                        </div>
                     </div>
