      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">New arriaval section</h4>
                ...
                <div class="col-sm-12">
                  <div class="demo-inline-spacing layout-sec mb-2">
                    ...
                    <div class="custom-control custom-control-primary custom-checkbox">
                         <input type="checkbox" class="custom-control-input" id="newarriaval" v-model="list.status"  />
                        <label class="custom-control-label" for="newarriaval"></label>
                    </div>
                  </div>
