    ...
    if (dt_filter_table.length) {
        ...
        var dt_basic = dt_filter_table.DataTable({
            ...
            initComplete: function(){
                if($("#shipping_method_create").length != 1)
                {
                    $("#btnCreate").remove();
                }

                if($("#shipping_method_edit").length != 1)
                {
                    $(".edit_btn").remove();
                }
                if($("#shipping_method_delete").length != 1)
                {
                    $(".delete_btn").remove();
                }
                if($("#shipping_method_export_access").length != 1)
                {
                    $("#exportbutton").remove();
                }
        ...
        $('div.head-label').html('<h6 class="mb-0">Shipping Method Listing</h6>');
    ...
    $('.dt-column-search tbody').on('click', '.delete-record', function(e) {
        ...
        Swal.fire({
            ...
            if (result.value) {
              ...
              Swal.fire({
                title: 'Cancelled',
                text: 'Your Shipping method is safe :)',
                icon: 'error',
                customClass: {
