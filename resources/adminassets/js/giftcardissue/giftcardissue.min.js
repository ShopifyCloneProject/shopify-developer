$(document).ready(function() {
    ...
    if (dt_filter_table.length) {
        ...
        var dt_filter_table = dt_filter_table.DataTable({
            ...
            initComplete: function(){
                ...
                if($("#gift_card_issue_create").length != 1)
                {
                    $("#btnCreate").remove();
                }

                if($("#gift_card_issue_show").length != 1)
                {
                    $(".view_btn").remove();
                }
                if($("#gift_card_issue_delete").length != 1)
                {
                    $(".delete_btn").remove();
                }
                if($("#gift_card_issue_edit").length != 1)
                {
                    $(".edit_btn").remove();
                }
                if($("#gift_card_issue_export").length != 1)
                {
                    $("#exportbutton").remove();
                }
        ...
        $('div.head-label').html('<h6 class="mb-0">Gift Card Issue Listing</h6>');
    ...
    $('.dt-column-search tbody').on('click', '.delete-record', function(e) {
      ...
      Swal.fire(deleteConfirmBox('gift card issue')).then(function (result) {
            if (result.value) {
              deleteRecord(id);
            } else if (result.dismiss === Swal.DismissReason.cancel) {
              safeRecord('gift card issue');
            }
        });
    });
    ...
    $(document).on('click', '.delete-selected', function(){
        Swal.fire(deleteConfirmBox('gift card issue')).then(function (result) {
            ...
            if (result.value) {
              ...
              safeRecord('all selected gift card issue');
            }
        });
    });
