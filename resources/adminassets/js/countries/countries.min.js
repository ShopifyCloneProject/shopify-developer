$(document).ready(function() {
    ...
    if (dt_filter_table.length) {
        ...
        var dt_filter_table = dt_filter_table.DataTable({
            ...
            initComplete: function(){
                ...
                if($("#country_create").length != 1)
                {
                    $("#btnCreate").remove();
                }

                if($("#country_edit").length != 1)
                {
                    $(".edit_btn").remove();
                }
                if($("#country_delete").length != 1)
                {
                    $(".delete_btn").remove();
                }
                if($("#country_export_access").length != 1)
                {
                    $("#exportbutton").remove();
                }
        ...
        $('div.head-label').html('<h6 class="mb-0">Country Listing</h6>');
    ...
    $('.data-submit').on('click', function(e) {
        ...
        e.preventDefault();
        var formData = {
            name: jQuery('#addCName').val(),
            short_code: jQuery('#addShortCode').val(),
            phone_code: jQuery('#addPhoneCode').val()
        };
        var type = "POST";
    ...
    $('.dt-column-search tbody').on('click', '.delete-record', function(e) {
      ...
      Swal.fire(deleteConfirmBox('country')).then(function (result) {
            if (result.value) {
              deleteRecord(id);
    ...
    $(document).on('click', '.delete-selected', function(){
        Swal.fire(deleteConfirmBox('country')).then(function (result) {
            ...
            if (result.value) {
              ...
              safeRecord('all selected country');
            }
        });
    });
    ...
    $(document).on('click', '.item-edit', function(){
        ...
        $('#editPhoneCode').val(data.phone_code);
        $('#default').modal('show');
    });
