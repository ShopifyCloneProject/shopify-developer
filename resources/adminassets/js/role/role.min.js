    ...
    if (dt_filter_table.length) {
        ...
        var dt_basic = dt_filter_table.DataTable({
            ...
            initComplete: function(){
                 ...
                 if($("#role_create").length != 1)
                {
                    $("#btnCreate").remove();
                }

                if($("#role_edit").length != 1)
                {
                    $(".edit_btn").remove();
                }
                if($("#role_delete").length != 1)
                {
                    $(".delete_btn").remove();
                }
                if($("#role_export_access").length != 1)
                {
                    $("#exportbutton").remove();
                }
        ...
        $('div.head-label').html('<h6 class="mb-0">Role Listing</h6>');
