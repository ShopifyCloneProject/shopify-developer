    ...
    if (dt_filter_table.length) {
        ...
        var dt_basic = dt_filter_table.DataTable({
            ...
            initComplete: function(){
                if($('#tag_create').length != 1)
                {
                    $('#create_new').remove();
                }
                if($('#tag_edit').length != 1)
                {
                    $('.btn_edit').remove();
                }
                if($('#tag_delete').length != 1)
                {
                    $('.btn_delete').remove();
                }
                if($('#tag_export').length != 1)
                {
                    $('#btn_tag_export').remove();
                }
        ...
        $('div.head-label').html('<h6 class="mb-0">Tags Listing</h6>');
