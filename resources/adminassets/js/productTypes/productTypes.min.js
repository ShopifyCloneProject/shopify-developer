    ...
    if (dt_filter_table.length) {
        ...
        var dt_filter_table = dt_filter_table.DataTable({
            ...
            initComplete: function(){
                ...
                if($("#product_type_create").length != 1)
                {
                    $("#btnCreate").remove();
                }

                if($("#product_type_show").length != 1)
                {
                    $(".view_btn").remove();
                }
                if($("#product_type_delete").length != 1)
                {
                    $(".delete_btn").remove();
                }
                if($("#product_type_edit").length != 1)
                {
                    $(".edit_btn").remove();
                }
                if($("#product_type_export").length != 1)
                {
                    $("#exportbutton").remove();
                }
        ...
        $('div.head-label').html('<h6 class="mb-0">Product Types Listing</h6>');
