    ...
    if (dt_filter_table.length) {
        ...
        var dt_basic = dt_filter_table.DataTable({
            ...
            initComplete: function(){
                ...
                if($("#dimensions_create").length != 1)
                {
                    $("#btnCreate").remove();
                }

                if($("#dimensions_edit").length != 1)
                {
                    $(".edit_btn").remove();
                }
                if($("#dimensions_delete").length != 1)
                {
                    $(".delete_btn").remove();
                }
                if($("#dimensions_export").length != 1)
                {
                    $("#exportbutton").remove();
                }
        ...
        $('div.head-label').html('<h6 class="mb-0">Dimensions Listing</h6>');
