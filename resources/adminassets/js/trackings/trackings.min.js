$(document).ready(function() {
    ...
    if (dt_filter_table.length) {
        ...
        var dt_filter_table = dt_filter_table.DataTable({
            ...
            initComplete: function(){
                ...
                if($("#tracking_create").length != 1)
                {
                    $("#btnCreate").remove();
                }

                if($("#tracking_edit").length != 1)
                {
                    $(".edit_btn").remove();
                }
                if($("#tracking_delete").length != 1)
                {
                    $(".delete_btn").remove();
                }
                if($("#tracking_export").length != 1)
                {
                    $("#exportbutton").remove();
                }
        ...
        $('div.head-label').html('<h6 class="mb-0">Tracking Listing</h6>');
    ...
    $('.dt-column-search tbody').on('click', '.delete-record', function(e) {
      ...
      Swal.fire(deleteConfirmBox('trackings')).then(function (result) {
            if (result.value) {
              deleteRecord(id);
            } else if (result.dismiss === Swal.DismissReason.cancel) {
              safeRecord('trackings');
            }
        });
    });
    ...
    $(document).on('click', '.delete-selected', function(){
        Swal.fire(deleteConfirmBox('trackings')).then(function (result) {
            ...
            if (result.value) {
              ...
              safeRecord('all selected trackings');
            }
        });
    });
