    ...
    if (dt_filter_table.length) {
        ...
        var dt_basic = dt_filter_table.DataTable({
            ...
            initComplete: function(){
                ...
                if($("#languages_settings_export").length != 1)
                {
                    $("#exportbutton").remove();
                }
                if($("#languages_settings_create").length != 1)
                {
                    $("#btnLanguageCreate").remove();
                }
                if($("#languages_settings_edit").length != 1)
                {
                    $(".btn_edit").remove();
                }
                if($("#languages_settings_delete").length != 1)
                {
                    $(".btn_delete").remove();
                }
        ...
        $('div.head-label').html('<h6 class="mb-0">Language Listing</h6>');
