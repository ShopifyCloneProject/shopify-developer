$(document).ready(function() {
    ...
    if (dt_filter_table.length) {
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        return (
                            ...
                            '</a>'+
                            ' <a href="javascript:;" class="m-l-5 delete-record" data-id="'+full.id+'">' +
        ...
        $('div.head-label').html('<h6 class="mb-0">Variant Listing</h6>');
