$(document).ready(function() {
    ...
    if (dt_filter_table.length) {
        ...
        var dt_basic = dt_filter_table.DataTable({
            ...
            initComplete: function(){
                ...
                if($("#currency_create").length != 1)
                {
                    $("#btnCurrencyCreate").remove();
                }

                if($("#currency_edit").length != 1)
                {
                    $(".edit_btn").remove();
                }
                if($("#currency_delete").length != 1)
                {
                    $(".delete_btn").remove();
                }
                if($("#currency_export_access").length != 1)
                {
                    $("#exportbutton").remove();
                }
        ...
        $('div.head-label').html('<h6 class="mb-0">Currency Listing</h6>');
    ...
    $('.data-submit').on('click', function(e) {
        ...
        e.preventDefault();
        var formData = {
            name: jQuery('#addCurrencyName').val(),
            currency: jQuery('#addCurrency').val(),
    ...
    $('.dt-column-search tbody').on('click', '.delete-record', function(e) {
       ...
       Swal.fire(deleteConfirmBox('currency')).then(function (result) {
            if (result.value) {
              deleteRecord(id);
    ...
    $(document).on('click', '.delete-selected', function(){
        Swal.fire(deleteConfirmBox('currency')).then(function (result) {
            if (result.value) {
              ...
              safeRecord('all selected currency');
            }
        });
    });
    ...
    $(document).on('click', '.item-edit', function(){
        ...
        $('#editCurrencyName').val(data.name);
