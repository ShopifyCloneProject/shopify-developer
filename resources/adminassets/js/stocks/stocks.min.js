$(document).ready(function() {
    ...
    if (dt_filter_table.length) {
        ...
        var dt_filter_table = dt_filter_table.DataTable({
            ...
            initComplete: function(){
                ...
                if($("#stock_create").length != 1)
                {
                    $("#btnCreate").remove();
                }

                if($("#stock_show").length != 1)
                {
                    $(".view_btn").remove();
                }
                if($("#stock_delete").length != 1)
                {
                    $(".delete_btn").remove();
                }
                if($("#stock_edit").length != 1)
                {
                    $(".edit_btn").remove();
                }
                if($("#stock_export").length != 1)
                {
                    $("#exportbutton").remove();
                }
        ...
        $('div.head-label').html('<h6 class="mb-0">Stock Listing</h6>');
    ...
    $('.dt-column-search tbody').on('click', '.delete-record', function(e) {
      ...
      Swal.fire(deleteConfirmBox('stock')).then(function (result) {
            if (result.value) {
              deleteRecord(id);
