    ...
    if (dt_filter_table.length) {
        ...
        var dt_basic = dt_filter_table.DataTable({
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        return (
                            ...
                            '<a href="javascript:;" class="item-edit btn_edit_access" data-id="'+full.id+'" >' +
                            feather.icons['edit'].toSvg({
                                class: 'font-small-4 mr-50'
                            }) +
                            '</a>' +
                            '<a href="javascript:;" class="delete-record btn_delete_access" data-id="'+full.id+'">' +
            ...
            initComplete: function(){
                ...
                if($("#permission_create").length != 1)
                {
                    $("#btnCreate").remove();
                }
                if($("#permission_edit").length != 1)
                {
                    $(".btn_edit_access").remove();
                }
                if($("#permission_delete").length != 1)
                {
                    $(".btn_delete_access").remove();
                }
                if($("#permission_export_access").length != 1)
                {
                    $("#exportbutton").remove();
                }
        ...
        $('div.head-label').html('<h6 class="mb-0">Permission Listing</h6>');
