$(document).ready(function() {
    ...
    if (dt_filter_table.length) {
        ...
        var dt_basic = dt_filter_table.DataTable({
            ...
            columns: [{ data: 'id' },
                      { data: 'id', name: 'id' },
                      { data: 'columnname', name: 'Name' },
                      { data: 'displaycolumnname', name: 'Display name' },
        ...
        $('div.head-label').html('<h6 class="mb-0">section Listing</h6>');
    ...
    $('.data-submit').on('click', function(e) {
        ...
        e.preventDefault();
        var formData = {
            name: jQuery('#addsectionName').val(),
            section: jQuery('#addsection').val(),
    ...
    $('.dt-column-search tbody').on('click', '.delete-record', function(e) {
       ...
       Swal.fire(deleteConfirmBox('section')).then(function (result) {
            if (result.value) {
              deleteRecord(id);
    ...
    $(document).on('click', '.delete-selected', function(){
        Swal.fire(deleteConfirmBox('section')).then(function (result) {
            if (result.value) {
              ...
              safeRecord('all selected section');
            }
        });
    });
