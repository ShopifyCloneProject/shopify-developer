$(document).ready(function() {
    ...
    if (dt_filter_table.length) {
        ...
        var dt_filter_table = dt_filter_table.DataTable({
            ...
            initComplete: function(){
                ...
                if($("#user_store_industry_create").length != 1)
                {
                    $("#btnCreate").remove();
                }

                if($("#user_store_industry_show").length != 1)
                {
                    $(".view_btn").remove();
                }
                if($("#user_store_industry_delete").length != 1)
                {
                    $(".delete_btn").remove();
                }
                if($("#user_store_industry_edit").length != 1)
                {
                    $(".edit_btn").remove();
                }
                if($("#user_store_industry_export").length != 1)
                {
                    $("#exportbutton").remove();
                }
        ...
        $('div.head-label').html('<h6 class="mb-0">User Store Industry Listing</h6>');
    ...
    $('.dt-column-search tbody').on('click', '.delete-record', function(e) {
      ...
      Swal.fire(deleteConfirmBox('industry')).then(function (result) {
            if (result.value) {
              deleteRecord(id);
    ...
    $(document).on('click', '.delete-selected', function(){
        Swal.fire(deleteConfirmBox('industry')).then(function (result) {
            ...
            if (result.value) {
              ...
              safeRecord('all selected industries');
            }
        });
    });
