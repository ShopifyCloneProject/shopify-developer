$(document).ready(function() {
    ...
    if (dt_filter_table.length) {
        ...
        var dt_filter_table = dt_filter_table.DataTable({
            ...
            initComplete: function(){
                ...
                if($("#gift_card_tag_show").length != 1)
                {
                    $(".view_btn").remove();
                }
                if($("#gift_card_tag_delete").length != 1)
                {
                    $(".delete_btn").remove();
                }
                if($("#gift_card_tag_edit").length != 1)
                {
                    $(".edit_btn").remove();
                }
                if($("#gift_card_tag_export").length != 1)
                {
                    $("#exportbutton").remove();
                }
        ...
        $('div.head-label').html('<h6 class="mb-0">Gift Card Tags Listing</h6>');
    ...
    $('.dt-column-search tbody').on('click', '.delete-record', function(e) {
      ...
      Swal.fire(deleteConfirmBox('gift card tags')).then(function (result) {
            if (result.value) {
              deleteRecord(id);
            } else if (result.dismiss === Swal.DismissReason.cancel) {
              safeRecord('gift card tags');
            }
        });
    });
    ...
    $(document).on('click', '.delete-selected', function(){
        Swal.fire(deleteConfirmBox('gift card tags')).then(function (result) {
            ...
            if (result.value) {
              ...
              safeRecord('all selected gift card tags');
            }
        });
    });
