    ...
    if (dt_filter_table.length) {
        ...
        var dt_filter_table = dt_filter_table.DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'variant_option_1_options',
                    name: 'variant_option_1.options'
                },
                 {
                    data: 'variant_option_2_options',
                    name: 'variant_option_2.options'
                },
 {
                    data: 'variant_option_3_options',
                    name: 'variant_option_3.options'
                },
                 {
                    data: 'src',
                    name: 'src'
                ...
                {
                    data: 'is_product_charge',
                    name: 'is_product_charge'
                },
                {
                    data: 'sku',
                    name: 'sku'
                ...
                {
                    data: 'weight_type_title',
                    name: 'weight_type_title'
                },
                {
                    data: 'country_name',
                    name: 'country_name'
                ...
                {
                    data: 'special_product_status',
                    name: 'special_product_status'
                },
                {
                    data: 'is_shipping',
                    name: 'is_shipping'
            ...
            initComplete: function(){
                ...
                if($("#product_variant_option_create").length != 1)
                {
                    $("#btnCreate").remove();
                }
                if($("#product_variant_option_edit").length != 1)
                {
                    $(".edit_btn").remove();
                }
                if($("#product_variant_option_show").length != 1)
                {
                    $(".view_btn").remove();
                }
                if($("#product_variant_option_delete").length != 1)
                {
                    $(".delete_btn").remove();
                }
                if($("#product_variant_option_export").length != 1)
                {
                    $("#exportbutton").remove();
                }
        ...
        $('div.head-label').html('<h6 class="mb-0">Product Variant Option Listing</h6>');
    ...
    $('.dt-column-search tbody').on('click', '.delete-record', function(e) {
      ...
      Swal.fire(deleteConfirmBox('product variant')).then(function (result) {
            if (result.value) {
              deleteRecord(id);
            } else if (result.dismiss === Swal.DismissReason.cancel) {
              safeRecord('product variant');
            }
        });
    });
    ...
    $(document).on('click', '.delete-selected', function(){
        Swal.fire(deleteConfirmBox('product variant')).then(function (result) {
            ...
            if (result.value) {
              ...
              safeRecord('all selected product variant');
            }
        });
    });
