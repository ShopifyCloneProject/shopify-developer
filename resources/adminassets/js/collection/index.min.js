    ...
    if (dt_filter_table.length) {
        ...
        var dt_basic = dt_filter_table.DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        var $row_output ='<a href="'+ getListingUrl + '/' + full.id + '/edit' + '" class="item-edit" data-id="'+full.id+'" >' +
                    ...
                    render: function(data, type, full, meta) {
                        return (
                           '<div class="d-inline-flex">' +
                            '<a href="'+ getListingUrl + '/' + full.id + '/edit' + '" class="item-edit btn_edit" data-id="'+full.id+'" >' +
            ...
            initComplete: function(){
                if($('#collection_create').length != 1)
                {
                    $('#btn_create_new').remove();
                }
                if($('#collection_edit').length != 1)
                {
                    $('.btn_edit').remove();
                }
                if($('#collection_delete').length != 1)
                {
                    $('.btn_delete').remove();
                }
                if($('#collection_export').length != 1)
                {
                    $('#btn_collection_export').remove();
                }
        ...
        $('div.head-label').html('<h6 class="mb-0">Collection Listing</h6>');
