    ...
    if (dt_filter_table.length) {
        ...
        var dt_filter_table = dt_filter_table.DataTable({
            ...
            initComplete: function(){
                ...
                if($("#fbpixel_create").length != 1)
                {
                    $("#btnCreate").remove();
                }

                if($("#fbpixel_edit").length != 1)
                {
                    $(".edit_btn").remove();
                }
                if($("#fbpixel_delete").length != 1)
                {
                    $(".delete_btn").remove();
                }
                if($("#fbpixel_export_access").length != 1)
                {
                    $("#exportbutton").remove();
                }
        ...
        $('div.head-label').html('<h6 class="mb-0">Facebook Pixel Listing</h6>');
