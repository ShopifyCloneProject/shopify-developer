$(document).ready(function() {
    ...
    if (dt_filter_table.length) {
        ...
        var dt_filter_table = dt_filter_table.DataTable({
            ...
            initComplete: function(){
                ...
                if($("#gift_card_vendor_edit").length != 1)
                {
                    $(".edit_btn").remove();
                }
                if($("#gift_card_vendor_show").length != 1)
                {
                    $(".view_btn").remove();
                }
                if($("#gift_card_vendor_delete").length != 1)
                {
                    $(".delete_btn").remove();
                }
                if($("#pgift_card_vendor_export").length != 1)
                {
                    $("#exportbutton").remove();
                }
    ...
    $('.dt-column-search tbody').on('click', '.delete-record', function(e) {
      ...
      Swal.fire(deleteConfirmBox('gift card vendor')).then(function (result) {
            if (result.value) {
              deleteRecord(id);
            } else if (result.dismiss === Swal.DismissReason.cancel) {
              safeRecord('gift card vendor');
            }
        });
    });
    ...
    $(document).on('click', '.delete-selected', function(){
        Swal.fire(deleteConfirmBox('gift card vendor')).then(function (result) {
            ...
            if (result.value) {
              ...
              safeRecord('all selected gift card vendor');
            }
        });
    });
