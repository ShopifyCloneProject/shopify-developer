$(document).ready(function() {
    ...
    if (dt_filter_table.length) {
        ...
        var dt_basic = dt_filter_table.DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    orderable: true,
                     render: function(data, type, full, meta) {
                        let path = "/assets/images/no-image.jpg";
                        if(full.theme_medias.length > 0){
                        path = APP_URL+"/storage/"+CLIENT_ID+"/themes/"+full.id+"/"+full.theme_medias[0].image;
                        }
                        var img = new Image();
                        img.src = path;
                        if (!img.complete) {
                        ...
                        return (
                            '<a href="'+path+'" target="_new"><img src="'+path+'" width="50" height="50"></a>'
                        );
                    }
                },
                {
            ...
            initComplete: function(){
                ...
                if($("#theme_export_access").length != 1)
                {
                    $("#exportbutton").remove();
                }
                if($("#theme_create").length != 1)
                {
                    $("#btn_create").remove();
                }
                if($("#theme_edit").length != 1)
                {
                    $(".btn_edit").remove();
                }
                if($("#theme_delete").length != 1)
                {
                    $(".btn_delete").remove();
                }
        ...
        $('div.head-label').html('<h6 class="mb-0">Themes Listing</h6>');
