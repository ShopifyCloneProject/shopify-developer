$(document).ready(function() {
    ...
    if (dt_filter_table.length) {
        ...
        var dt_basic = dt_filter_table.DataTable({
                    ...
                    render: function(data, type, full, meta) {
                        return (
                            ...
                            feather.icons['edit'].toSvg({
                                class: 'font-small-4 btn-edit-access mr-50'
                            }) +
                            '</a>' +
            ...
            initComplete: function(){
                ...
                if($("#time_zone_create").length != 1)
                {
                    $("#btnCreate").remove();
                }
                if($("#time_zone_edit").length != 1)
                {
                    $(".edit_btn").remove();
                }
                if($("#time_zone_delete").length != 1)
                {
                    $(".delete_btn").remove();
                }
                if($("#timezone_export_access").length != 1)
                {
                    $("#exportbutton").remove();
                }
        ...
        $('div.head-label').html('<h6 class="mb-0">Timezone Listing</h6>');
    ...
    $('.data-submit').on('click', function(e) {
        ...
        var formData = {
            ...
            timezone_value: jQuery('#addValue').val(),
        };
        var type = "POST";
    ...
    $(document).on('click', '.item-edit', function(){
        ...
        $('#timezoneId').val(data.id);
        $('#editTitle').val(data.title);
        $('#editValue').val(data.timezone_value);
        $('#default').modal('show');
    });
    ...
    $(document).on('click', '.data-edit', function(){
        ...
        let id = $('#timezoneId').val(),
        title = $('#editTitle').val(),
        timezone_value = $('#editValue').val();
