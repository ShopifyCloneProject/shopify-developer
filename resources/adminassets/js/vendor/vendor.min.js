    ...
    if (dt_filter_table.length) {
        ...
        var dt_basic = dt_filter_table.DataTable({
            ...
            initComplete: function(){
                 if($('#vendor_create').length != 1)
                {
                    $('#create_new').remove();
                }
                if($('#vendor_edit').length != 1)
                {
                    $('.btn_edit').remove();
                }
                if($('#vendor_delete').length != 1)
                {
                    $('.btn_delete').remove();
                }
                if($('#vendor_export').length != 1)
                {
                    $('#btn_vendor_export').remove();
                }
        ...
        $('div.head-label').html('<h6 class="mb-0">Vendors Listing</h6>');
